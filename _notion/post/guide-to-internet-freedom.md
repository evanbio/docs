...
2. 填写邮箱、密码，输入邀请码 `KjPj7zUw`（如需）
    ...
    ![image.png](../image/guide-to-internet-freedom_1.png)
    
3. 登录后点击左侧菜单「购买订阅」，选择套餐并付款（推荐年付小包）
    
    ![image.png](../image/guide-to-internet-freedom_2.png)
...
1. 下载 v2rayN 客户端：
    ...
    ![image.png](../image/guide-to-internet-freedom_3.png)
    
2. 解压并运行 `v2rayN.exe`，如提示需安装 .NET 环境，按指引完成安装
3. 启动软件 → 点击「订阅」 → 添加订阅链接（复制自机场后台）
    
    ![image.png](../image/guide-to-internet-freedom_4.png)
    
4. 更新订阅 → 右键任一节点设为活动服务器 → 启动服务
    
    ![image.png](../image/guide-to-internet-freedom_5.png)
