...
![create-account-google_1](../image/create-account-google_1.png)
...
1. 点击浏览器右上角的"三点"图标，选择 **Settings（设置）**。
    ...
    ![create-account-google_2](../image/create-account-google_2.png)

2. 在左侧导航栏中选择 **Languages（语言）**，将英语移至首位，并移除中文选项。

    ![create-account-google_3](../image/create-account-google_3.png)
...
2. 在登录界面选择 **Create account（创建账号）**，并选择 **For my personal use（个人用途）**。
    ...
    ![create-account-google_4](../image/create-account-google_4.png)
