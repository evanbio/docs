...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Evan Zhou', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Not All Who Wander Are Lost', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://docs.evanzhou.org/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'notion, blog, evan zhou, docs', // 网站关键词 英文逗号隔开
